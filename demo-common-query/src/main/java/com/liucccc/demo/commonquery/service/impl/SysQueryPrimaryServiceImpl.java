package com.liucccc.demo.commonquery.service.impl;

import com.baomidou.mybatisplus.core.conditions.query.LambdaQueryWrapper;
import com.baomidou.mybatisplus.extension.service.impl.ServiceImpl;
import com.liucccc.demo.common.exception.BizException;
import com.liucccc.demo.commonquery.dao.SysQueryPrimaryMapper;
import com.liucccc.demo.commonquery.entity.SysQueryPrimary;
import com.liucccc.demo.commonquery.entity.SysQueryTemplate;
import com.liucccc.demo.commonquery.entity.SysQueryTemplateCols;
import com.liucccc.demo.commonquery.service.SysQueryPrimaryService;
import com.liucccc.demo.commonquery.service.SysQueryTemplateService;
...
public class SysQueryPrimaryServiceImpl extends ServiceImpl<SysQueryPrimaryMapper, SysQueryPrimary> implements SysQueryPrimaryService {
    ...
    public boolean updateQueryPrimary(String templateId, List<SysQueryTemplateCols> colsList) {
        ...
        for (int i = 0; i < colsList.size(); i++) {
            ...
            if (BigDecimal.valueOf(1).equals(colsList.get(i).getStaFlag())) {
                if (statCols != null && statCols.length() > 0) {
                    statCols.append(",");
                }
